...
load('../PECA_scr/MotifMatch_mouse_rmdup.mat')
load('../PECA_scr/TFTG_corr_mouse.mat')
TF_binding=mfbs(TFName,Element_name,motifName,motifWeight,Match2);
fileID = fopen('toreplace.txt');
C = textscan(fileID,'%s %f32');
fclose(fileID);
Symbol=C{1,1};
G=C{1,2};
%%%%CR binding
load('../PECA_scr/CRInfo_mouse.mat')
eita0=-30.4395;
eita1=0.8759;
...
%%%%%%%%%
load('../PECA_scr/TFTG_mouse_nagetriveControl.mat')
